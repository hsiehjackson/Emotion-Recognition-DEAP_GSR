...
def main():
	...
	trainTask([0,2694],'fusion_th.csv')
	'''
...
def trainTask(task,outfile):
	...
	writefeat('gsr_result/gsr_fusion/report/ft/'+outfile,a_best_feature,vote_a,'arousal','w')
	writefeat('gsr_result/gsr_fusion/report/ft/'+outfile,v_best_feature,vote_v,'valence','a')
